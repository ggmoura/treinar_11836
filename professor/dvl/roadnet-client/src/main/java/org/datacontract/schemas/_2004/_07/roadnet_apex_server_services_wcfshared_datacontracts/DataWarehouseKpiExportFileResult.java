...
/**
 * <p>Classe Java de DataWarehouseKpiExportFileResult complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="DataWarehouseKpiExportFileResult"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DataWarehouseKpiExportFileResult", propOrder = {
...
public class DataWarehouseKpiExportFileResult
    extends DataTransferObject
{

    @XmlElementRef(name = "DataWarehouseFileType_FileType", namespace = "http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.WCFShared.DataContracts.DataWarehouse", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dataWarehouseFileTypeFileType;
    @XmlElementRef(name = "FileName", namespace = "http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.WCFShared.DataContracts.DataWarehouse", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fileName;
    @XmlElement(name = "FileSize")
    protected Long fileSize;
    @XmlElementRef(name = "FileUrl", namespace = "http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.WCFShared.DataContracts.DataWarehouse", type = JAXBElement.class, required = false)

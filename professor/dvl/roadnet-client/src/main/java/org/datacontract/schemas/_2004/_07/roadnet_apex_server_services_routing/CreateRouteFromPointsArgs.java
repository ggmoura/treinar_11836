...
/**
 * <p>Classe Java de CreateRouteFromPointsArgs complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="CreateRouteFromPointsArgs"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CreateRouteFromPointsArgs", propOrder = {
    "originCoordinate",
    "plannedStartTime",
    "returnInclusionMode",
...
public class CreateRouteFromPointsArgs
    extends DataTransferObject
{
    ...
    @XmlElementRef(name = "RouteDescription", namespace = "http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts", type = JAXBElement.class, required = false)
    protected JAXBElement<String> routeDescription;
    @XmlElementRef(name = "RouteIdentifier", namespace = "http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts", type = JAXBElement.class, required = false)

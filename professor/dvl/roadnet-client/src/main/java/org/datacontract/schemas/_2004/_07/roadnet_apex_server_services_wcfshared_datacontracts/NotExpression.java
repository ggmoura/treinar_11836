...
@XmlType(name = "NotExpression", namespace = "http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.WCFShared.DataContracts.Expression", propOrder = {
    "expression"
})
    ...
    extends SimpleExpressionBase
{
    ...
    @XmlElementRef(name = "Expression", namespace = "http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.WCFShared.DataContracts.Expression", type = JAXBElement.class, required = false)

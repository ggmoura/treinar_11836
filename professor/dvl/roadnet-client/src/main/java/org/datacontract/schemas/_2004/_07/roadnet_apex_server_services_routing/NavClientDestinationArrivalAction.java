...
/**
 * <p>Classe Java de NavClientDestinationArrivalAction complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="NavClientDestinationArrivalAction"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "NavClientDestinationArrivalAction", propOrder = {
    "destinationIdentifier"
})
public class NavClientDestinationArrivalAction
    extends NavClientAction
{

    @XmlElementRef(name = "DestinationIdentifier", namespace = "http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts", type = JAXBElement.class, required = false)

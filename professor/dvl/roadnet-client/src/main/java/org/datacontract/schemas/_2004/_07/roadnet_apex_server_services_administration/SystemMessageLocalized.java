...
/**
 * <p>Classe Java de SystemMessageLocalized complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="SystemMessageLocalized"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SystemMessageLocalized", propOrder = {
    "culture",
    "message"
})
public class SystemMessageLocalized
    extends DomainEntity
{

    @XmlElementRef(name = "Culture", namespace = "http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Administration.DataContracts", type = JAXBElement.class, required = false)
    protected JAXBElement<String> culture;
    @XmlElementRef(name = "Message", namespace = "http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Administration.DataContracts", type = JAXBElement.class, required = false)

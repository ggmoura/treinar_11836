 ...
 *         &lt;element name="options" type="{http://roadnet.com/apex/DataContracts/}EquipmentMaintenanceInfoRetrievalOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveEquipmentMaintenanceInfo")
public class RetrieveEquipmentMaintenanceInfo {
    ...
    protected JAXBElement<EquipmentMaintenanceInfoRetrievalOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link EquipmentMaintenanceInfoRetrievalOptions }{@code >}
     *     
     */
    public JAXBElement<EquipmentMaintenanceInfoRetrievalOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<EquipmentMaintenanceInfoRetrievalOptions> value) {
        this.options = value;
    }

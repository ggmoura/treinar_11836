 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}UndeleteEntityOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Undelete {
    ...
    protected JAXBElement<UndeleteEntityOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link UndeleteEntityOptions }{@code >}
     *     
     */
    public JAXBElement<UndeleteEntityOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<UndeleteEntityOptions> value) {
        this.options = value;
    }

 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Mapping.DataContracts}RetrieveMapChangedAreasOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveMapChangedAreas")
public class RetrieveMapChangedAreas {
    ...
    @XmlElementRef(name = "viewport", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    ...
    protected JAXBElement<RetrieveMapChangedAreasOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RetrieveMapChangedAreasOptions }{@code >}
     *     
     */
    public JAXBElement<RetrieveMapChangedAreasOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<RetrieveMapChangedAreasOptions> value) {
        this.options = value;
    }

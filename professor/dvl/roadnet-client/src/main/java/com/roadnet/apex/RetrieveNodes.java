 ...
 *         &lt;element name="criteria" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Mapping.DataContracts}RetrieveNodesCriteria" minOccurs="0"/&gt;
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Mapping.DataContracts}RetrieveNodesOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveNodes")
public class RetrieveNodes {
    ...
    protected JAXBElement<RetrieveNodesCriteria> criteria;
    @XmlElementRef(name = "options", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<RetrieveNodesOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RetrieveNodesCriteria }{@code >}
     *     
     */
    public JAXBElement<RetrieveNodesCriteria> getCriteria() {
        return criteria;
    }
     ...
     *     
     */
    public void setCriteria(JAXBElement<RetrieveNodesCriteria> value) {
        this.criteria = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RetrieveNodesOptions }{@code >}
     *     
     */
    public JAXBElement<RetrieveNodesOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<RetrieveNodesOptions> value) {
        this.options = value;
    }

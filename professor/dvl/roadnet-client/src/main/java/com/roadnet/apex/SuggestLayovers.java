 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}SuggestLayoverOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SuggestLayovers")
public class SuggestLayovers {
    ...
    protected JAXBElement<SuggestLayoverOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SuggestLayoverOptions }{@code >}
     *     
     */
    public JAXBElement<SuggestLayoverOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<SuggestLayoverOptions> value) {
        this.options = value;
    }

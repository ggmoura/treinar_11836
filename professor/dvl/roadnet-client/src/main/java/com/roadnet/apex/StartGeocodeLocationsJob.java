...
@XmlRootElement(name = "StartGeocodeLocationsJob")
public class StartGeocodeLocationsJob {
    ...
    @XmlElementRef(name = "LocationEntityKeys", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)

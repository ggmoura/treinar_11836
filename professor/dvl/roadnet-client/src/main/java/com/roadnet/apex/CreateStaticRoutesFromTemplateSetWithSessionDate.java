...
@XmlRootElement(name = "CreateStaticRoutesFromTemplateSetWithSessionDate")
public class CreateStaticRoutesFromTemplateSetWithSessionDate {
    ...
    @XmlElementRef(name = "sessionDate", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)

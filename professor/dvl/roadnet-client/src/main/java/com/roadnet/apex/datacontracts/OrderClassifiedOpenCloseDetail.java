...
/**
 * <p>Classe Java de OrderClassifiedOpenCloseDetail complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="OrderClassifiedOpenCloseDetail"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://roadnet.com/apex/DataContracts/}OpenCloseDetail"&gt;
 *       &lt;sequence&gt;
...
@XmlType(name = "OrderClassifiedOpenCloseDetail", propOrder = {
    "orderClassEntityKey"
})
@XmlSeeAlso({
    ServiceLocationOpenCloseDetail.class,
    TimeWindowTypeOpenCloseDetail.class
})
public class OrderClassifiedOpenCloseDetail
    extends OpenCloseDetail
{

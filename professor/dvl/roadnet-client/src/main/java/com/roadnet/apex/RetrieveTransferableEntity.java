...
@XmlRootElement(name = "RetrieveTransferableEntity")
public class RetrieveTransferableEntity {
    ...
    @XmlElementRef(name = "entityName", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)

 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}RetrieveRoutesOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveRoutesForDevice")
public class RetrieveRoutesForDevice {
    ...
    protected JAXBElement<RetrieveRoutesOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RetrieveRoutesOptions }{@code >}
     *     
     */
    public JAXBElement<RetrieveRoutesOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<RetrieveRoutesOptions> value) {
        this.options = value;
    }

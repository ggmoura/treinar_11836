 ...
 *         &lt;element name="parameters" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}SendOrdersParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SendOrders {
    ...
    protected JAXBElement<SendOrdersParameters> parameters;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SendOrdersParameters }{@code >}
     *     
     */
    public JAXBElement<SendOrdersParameters> getParameters() {
        return parameters;
    }
     ...
     *     
     */
    public void setParameters(JAXBElement<SendOrdersParameters> value) {

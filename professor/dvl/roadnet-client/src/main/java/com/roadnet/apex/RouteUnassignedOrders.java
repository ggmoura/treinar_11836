 ...
 *         &lt;element name="unassignedOrders" type="{http://roadnet.com/apex/DataContracts/}ArrayOfDomainInstance" minOccurs="0"/&gt;
...
@XmlRootElement(name = "RouteUnassignedOrders")
public class RouteUnassignedOrders {
    ...
    @XmlElementRef(name = "unassignedOrders", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfDomainInstance> unassignedOrders;
     ...
     *     
     */
    public JAXBElement<ArrayOfDomainInstance> getUnassignedOrders() {
     ...
     *     
     */
    public void setUnassignedOrders(JAXBElement<ArrayOfDomainInstance> value) {

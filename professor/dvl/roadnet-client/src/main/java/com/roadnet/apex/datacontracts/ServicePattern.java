...
/**
 * <p>Classe Java de ServicePattern complex type.
 * 
 ...
 *         &lt;element name="PercentQuantitiesPerVisit" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOfint" minOccurs="0"/&gt;
...
@XmlType(name = "ServicePattern", propOrder = {
    "description",
    "identifier",
    "isDeleted",
...
@XmlSeeAlso({
    DayOfWeekServicePattern.class,
    TimePeriodServicePattern.class
})
    ...
    extends BusinessUnitBasedAggregateRootEntity
{
    ...
    @XmlElementRef(name = "PercentQuantitiesPerVisit", namespace = "http://roadnet.com/apex/DataContracts/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfint> percentQuantitiesPerVisit;
     ...
     *     
     */
    public JAXBElement<ArrayOfint> getPercentQuantitiesPerVisit() {
     ...
     *     
     */
    public void setPercentQuantitiesPerVisit(JAXBElement<ArrayOfint> value) {

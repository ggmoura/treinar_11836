...
@XmlRootElement(name = "RetrieveNavigationDeviceStatus")
public class RetrieveNavigationDeviceStatus {
    ...
    @XmlElementRef(name = "mobileDeviceEntityKeys", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)

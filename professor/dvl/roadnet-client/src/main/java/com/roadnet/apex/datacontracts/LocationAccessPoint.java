...
/**
 * <p>Classe Java de LocationAccessPoint complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="LocationAccessPoint"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.DataTransferObjectMapping}DomainEntity"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="AccessType_Type" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "LocationAccessPoint", propOrder = {
    "accessTypeType",
    "coordinate"
})
    ...
    extends DomainEntity
{
    ...
    @XmlElementRef(name = "AccessType_Type", namespace = "http://roadnet.com/apex/DataContracts/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> accessTypeType;
     ...
     *     
     */
    public JAXBElement<String> getAccessTypeType() {
     ...
     *     
     */
    public void setAccessTypeType(JAXBElement<String> value) {

 ...
 *         &lt;element name="splitRouteOptions" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing}SplitRouteOptionsDto" minOccurs="0"/&gt;
 *         &lt;element name="retrievalOptions" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.Options}RouteRetrievalOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SplitRoute")
public class SplitRoute {
    ...
    @XmlElementRef(name = "splitRouteOptions", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<SplitRouteOptionsDto> splitRouteOptions;
    @XmlElementRef(name = "retrievalOptions", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<RouteRetrievalOptions> retrievalOptions;
    ...
    /**
     * Obtém o valor da propriedade splitRouteOptions.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SplitRouteOptionsDto }{@code >}
     *     
     */
    public JAXBElement<SplitRouteOptionsDto> getSplitRouteOptions() {
        return splitRouteOptions;
    }

    /**
     * Define o valor da propriedade splitRouteOptions.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link SplitRouteOptionsDto }{@code >}
     *     
     */
    public void setSplitRouteOptions(JAXBElement<SplitRouteOptionsDto> value) {
        this.splitRouteOptions = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RouteRetrievalOptions }{@code >}
     *     
     */
    public JAXBElement<RouteRetrievalOptions> getRetrievalOptions() {
     ...
     *     
     */
    public void setRetrievalOptions(JAXBElement<RouteRetrievalOptions> value) {

 ...
 *         &lt;element name="parameters" type="{http://roadnet.com/apex/DataContracts/}OptimizeTerritoriesParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "OptimizeTerritories")
public class OptimizeTerritories {
    ...
    protected JAXBElement<OptimizeTerritoriesParameters> parameters;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link OptimizeTerritoriesParameters }{@code >}
     *     
     */
    public JAXBElement<OptimizeTerritoriesParameters> getParameters() {
        return parameters;
    }
     ...
     *     
     */
    public void setParameters(JAXBElement<OptimizeTerritoriesParameters> value) {

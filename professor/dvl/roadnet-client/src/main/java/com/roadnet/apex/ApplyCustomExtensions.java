 ...
 *       &lt;sequence&gt;
 *         &lt;element name="objects" type="{http://roadnet.com/apex/DataContracts/}ArrayOfCustomEntityMetaData" minOccurs="0"/&gt;
...
@XmlRootElement(name = "ApplyCustomExtensions")
public class ApplyCustomExtensions {

    @XmlElementRef(name = "objects", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfCustomEntityMetaData> objects;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfCustomEntityMetaData }{@code >}
     *     
     */
    public JAXBElement<ArrayOfCustomEntityMetaData> getObjects() {
        return objects;
    }
     ...
     *     
     */
    public void setObjects(JAXBElement<ArrayOfCustomEntityMetaData> value) {
        this.objects = value;
    }

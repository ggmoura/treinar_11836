 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}PreviewRouteOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PreviewRoute")
public class PreviewRoute {
    ...
    protected JAXBElement<PreviewRouteOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PreviewRouteOptions }{@code >}
     *     
     */
    public JAXBElement<PreviewRouteOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<PreviewRouteOptions> value) {
        this.options = value;
    }

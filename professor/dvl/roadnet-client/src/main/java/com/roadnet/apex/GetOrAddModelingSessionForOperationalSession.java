...
@XmlRootElement(name = "GetOrAddModelingSessionForOperationalSession")
public class GetOrAddModelingSessionForOperationalSession {
    ...
    @XmlElementRef(name = "sessionDescription", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)

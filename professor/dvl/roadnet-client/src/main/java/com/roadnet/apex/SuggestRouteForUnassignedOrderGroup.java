 ...
 *         &lt;element name="unassignedOrderGroupInstance" type="{http://roadnet.com/apex/DataContracts/}DomainInstance" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = {
    "regionContext",
    "parameters",
    "unassignedOrderGroupInstance"
})
@XmlRootElement(name = "SuggestRouteForUnassignedOrderGroup")
public class SuggestRouteForUnassignedOrderGroup {
    ...
    @XmlElementRef(name = "unassignedOrderGroupInstance", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<DomainInstance> unassignedOrderGroupInstance;
    ...
    /**
     * Obtém o valor da propriedade unassignedOrderGroupInstance.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<DomainInstance> getUnassignedOrderGroupInstance() {
        return unassignedOrderGroupInstance;
    }

    /**
     * Define o valor da propriedade unassignedOrderGroupInstance.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link DomainInstance }{@code >}
     *     
     */
    public void setUnassignedOrderGroupInstance(JAXBElement<DomainInstance> value) {
        this.unassignedOrderGroupInstance = value;
    }

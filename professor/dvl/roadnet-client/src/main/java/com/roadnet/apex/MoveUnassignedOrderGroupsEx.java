 ...
 *         &lt;element name="unassignedOrderGroupInstances" type="{http://roadnet.com/apex/DataContracts/}ArrayOfDomainInstance" minOccurs="0"/&gt;
 ...
 *         &lt;element name="moveUnassignedOrderGroupsOptions" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}MoveUnassignedOrderGroupsOptions" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = {
    "context",
    "unassignedOrderGroupInstances",
    "placement",
    "moveUnassignedOrderGroupsOptions",
    "retrievalOptions"
})
@XmlRootElement(name = "MoveUnassignedOrderGroupsEx")
public class MoveUnassignedOrderGroupsEx {
    ...
    @XmlElementRef(name = "unassignedOrderGroupInstances", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfDomainInstance> unassignedOrderGroupInstances;
    ...
    @XmlElementRef(name = "moveUnassignedOrderGroupsOptions", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<MoveUnassignedOrderGroupsOptions> moveUnassignedOrderGroupsOptions;
    ...
    /**
     * Obtém o valor da propriedade unassignedOrderGroupInstances.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<ArrayOfDomainInstance> getUnassignedOrderGroupInstances() {
        return unassignedOrderGroupInstances;
    }

    /**
     * Define o valor da propriedade unassignedOrderGroupInstances.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfDomainInstance }{@code >}
     *     
     */
    public void setUnassignedOrderGroupInstances(JAXBElement<ArrayOfDomainInstance> value) {
        this.unassignedOrderGroupInstances = value;
    }
    ...
    /**
     * Obtém o valor da propriedade moveUnassignedOrderGroupsOptions.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link MoveUnassignedOrderGroupsOptions }{@code >}
     *     
     */
    public JAXBElement<MoveUnassignedOrderGroupsOptions> getMoveUnassignedOrderGroupsOptions() {
        return moveUnassignedOrderGroupsOptions;
    }

    /**
     * Define o valor da propriedade moveUnassignedOrderGroupsOptions.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link MoveUnassignedOrderGroupsOptions }{@code >}
     *     
     */
    public void setMoveUnassignedOrderGroupsOptions(JAXBElement<MoveUnassignedOrderGroupsOptions> value) {
        this.moveUnassignedOrderGroupsOptions = value;
    }

...
/**
 * <p>Classe Java de ResourceExceptionRule.RuleType.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * <p>
 * <pre>
 * &lt;simpleType name="ResourceExceptionRule.RuleType"&gt;
 ...
 * 
 */
@XmlType(name = "ResourceExceptionRule.RuleType")
@XmlEnum
public enum ResourceExceptionRuleRuleType {
    ...
    ResourceExceptionRuleRuleType(String v) {
        value = v;
    }
    ...
    public static ResourceExceptionRuleRuleType fromValue(String v) {
        for (ResourceExceptionRuleRuleType c: ResourceExceptionRuleRuleType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }

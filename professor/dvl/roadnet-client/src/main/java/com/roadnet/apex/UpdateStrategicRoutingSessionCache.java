 ...
 *         &lt;element name="parameters" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.Routing}UpdateStrategicPlanningSessionCacheJobParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "UpdateStrategicRoutingSessionCache")
public class UpdateStrategicRoutingSessionCache {
    ...
    protected JAXBElement<UpdateStrategicPlanningSessionCacheJobParameters> parameters;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link UpdateStrategicPlanningSessionCacheJobParameters }{@code >}
     *     
     */
    public JAXBElement<UpdateStrategicPlanningSessionCacheJobParameters> getParameters() {
        return parameters;
    }
     ...
     *     
     */
    public void setParameters(JAXBElement<UpdateStrategicPlanningSessionCacheJobParameters> value) {

 ...
 *         &lt;element name="moveToRouteParameters" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}MoveToRouteParameters" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = {
    "context",
    "moveToRouteParameters",
    "placement",
    "retrievalOptions"
})
@XmlRootElement(name = "MoveToRouteAndTemporaryGeocode")
public class MoveToRouteAndTemporaryGeocode {
    ...
    @XmlElementRef(name = "moveToRouteParameters", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<MoveToRouteParameters> moveToRouteParameters;
    ...
    /**
     * Obtém o valor da propriedade moveToRouteParameters.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link MoveToRouteParameters }{@code >}
     *     
     */
    public JAXBElement<MoveToRouteParameters> getMoveToRouteParameters() {
        return moveToRouteParameters;
    }

    /**
     * Define o valor da propriedade moveToRouteParameters.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link MoveToRouteParameters }{@code >}
     *     
     */
    public void setMoveToRouteParameters(JAXBElement<MoveToRouteParameters> value) {
        this.moveToRouteParameters = value;
    }

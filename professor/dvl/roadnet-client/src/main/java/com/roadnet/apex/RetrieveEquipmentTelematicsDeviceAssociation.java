 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Query.DataContracts}LookupEquipmentOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveEquipmentTelematicsDeviceAssociation")
public class RetrieveEquipmentTelematicsDeviceAssociation {
    ...
    protected JAXBElement<LookupEquipmentOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link LookupEquipmentOptions }{@code >}
     *     
     */
    public JAXBElement<LookupEquipmentOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<LookupEquipmentOptions> value) {
        this.options = value;
    }

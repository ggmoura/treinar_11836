 ...
 *         &lt;element name="parameters" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.PrepareForNextDay}PrepareForNextDayJobParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PrepareForNextDay")
public class PrepareForNextDay {
    ...
    protected JAXBElement<PrepareForNextDayJobParameters> parameters;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PrepareForNextDayJobParameters }{@code >}
     *     
     */
    public JAXBElement<PrepareForNextDayJobParameters> getParameters() {
        return parameters;
    }
     ...
     *     
     */
    public void setParameters(JAXBElement<PrepareForNextDayJobParameters> value) {

 ...
 *         &lt;element name="options" type="{http://roadnet.com/apex/DataContracts/}RetrieveOperationalMetricsOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveOperationalMetrics")
public class RetrieveOperationalMetrics {
    ...
    protected JAXBElement<RetrieveOperationalMetricsOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RetrieveOperationalMetricsOptions }{@code >}
     *     
     */
    public JAXBElement<RetrieveOperationalMetricsOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<RetrieveOperationalMetricsOptions> value) {
        this.options = value;
    }

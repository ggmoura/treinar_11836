 ...
 *         &lt;element name="retrievalOptions" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Query.DataContracts}ServiceableStopTemplateRetrievalOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveStopTemplates")
public class RetrieveStopTemplates {
    ...
    protected JAXBElement<ServiceableStopTemplateRetrievalOptions> retrievalOptions;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ServiceableStopTemplateRetrievalOptions }{@code >}
     *     
     */
    public JAXBElement<ServiceableStopTemplateRetrievalOptions> getRetrievalOptions() {
     ...
     *     
     */
    public void setRetrievalOptions(JAXBElement<ServiceableStopTemplateRetrievalOptions> value) {

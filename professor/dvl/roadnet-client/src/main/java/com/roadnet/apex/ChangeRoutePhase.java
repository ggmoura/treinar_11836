...
import com.roadnet.apex.datacontracts.RoutePhase;
 ...
 *         &lt;element name="routePhase" type="{http://roadnet.com/apex/DataContracts/}RoutePhase" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ChangeRoutePhase")
public class ChangeRoutePhase {
    ...
    protected RoutePhase routePhase;
    ...
    /**
     * Obtém o valor da propriedade routePhase.
     * 
     * @return
     *     possible object is
     *     {@link RoutePhase }
     *     
     */
    public RoutePhase getRoutePhase() {
        return routePhase;
    }

    /**
     * Define o valor da propriedade routePhase.
     * 
     * @param value
     *     allowed object is
     *     {@link RoutePhase }
     *     
     */
    public void setRoutePhase(RoutePhase value) {
        this.routePhase = value;
    }

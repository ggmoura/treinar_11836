 ...
 *         &lt;element name="parameters" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.MoveUnassignedOrdersToSession}MoveUnassignedOrdersToSessionJobParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "MoveUnassignedOrdersToSession")
public class MoveUnassignedOrdersToSession {
    ...
    protected JAXBElement<MoveUnassignedOrdersToSessionJobParameters> parameters;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link MoveUnassignedOrdersToSessionJobParameters }{@code >}
     *     
     */
    public JAXBElement<MoveUnassignedOrdersToSessionJobParameters> getParameters() {
        return parameters;
    }
     ...
     *     
     */
    public void setParameters(JAXBElement<MoveUnassignedOrdersToSessionJobParameters> value) {

 ...
 *         &lt;element name="options" type="{http://roadnet.com/apex/DataContracts/}RetrieveEquipmentStatusOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveEquipmentStatus")
public class RetrieveEquipmentStatus {
    ...
    protected JAXBElement<RetrieveEquipmentStatusOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RetrieveEquipmentStatusOptions }{@code >}
     *     
     */
    public JAXBElement<RetrieveEquipmentStatusOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<RetrieveEquipmentStatusOptions> value) {
        this.options = value;
    }

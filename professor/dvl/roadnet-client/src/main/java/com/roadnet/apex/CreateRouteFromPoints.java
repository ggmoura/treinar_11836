 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}CreateRouteFromPointsArgs" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CreateRouteFromPoints")
public class CreateRouteFromPoints {
    ...
    protected JAXBElement<CreateRouteFromPointsArgs> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CreateRouteFromPointsArgs }{@code >}
     *     
     */
    public JAXBElement<CreateRouteFromPointsArgs> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<CreateRouteFromPointsArgs> value) {
        this.options = value;
    }

 ...
 *         &lt;element name="criteria" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Mapping.DataContracts}UpdateNodeCriteria" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class UpdateNode {
    ...
    protected JAXBElement<UpdateNodeCriteria> criteria;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link UpdateNodeCriteria }{@code >}
     *     
     */
    public JAXBElement<UpdateNodeCriteria> getCriteria() {
        return criteria;
    }
     ...
     *     
     */
    public void setCriteria(JAXBElement<UpdateNodeCriteria> value) {
        this.criteria = value;
    }

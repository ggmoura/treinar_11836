...
@XmlRootElement(name = "RetrieveRelevantDownloadableClientApplicationVersions")
public class RetrieveRelevantDownloadableClientApplicationVersions {

    @XmlElementRef(name = "mobileDeviceIdentifier", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)

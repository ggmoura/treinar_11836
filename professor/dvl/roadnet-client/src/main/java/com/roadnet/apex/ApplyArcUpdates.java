 ...
 *         &lt;element name="criteria" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Mapping.DataContracts}ApplyArcUpdatesCriteria" minOccurs="0"/&gt;
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Mapping.DataContracts}ApplyArcUpdatesOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ApplyArcUpdates")
public class ApplyArcUpdates {
    ...
    protected JAXBElement<ApplyArcUpdatesCriteria> criteria;
    @XmlElementRef(name = "options", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<ApplyArcUpdatesOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ApplyArcUpdatesCriteria }{@code >}
     *     
     */
    public JAXBElement<ApplyArcUpdatesCriteria> getCriteria() {
        return criteria;
    }
     ...
     *     
     */
    public void setCriteria(JAXBElement<ApplyArcUpdatesCriteria> value) {
        this.criteria = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ApplyArcUpdatesOptions }{@code >}
     *     
     */
    public JAXBElement<ApplyArcUpdatesOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<ApplyArcUpdatesOptions> value) {
        this.options = value;
    }

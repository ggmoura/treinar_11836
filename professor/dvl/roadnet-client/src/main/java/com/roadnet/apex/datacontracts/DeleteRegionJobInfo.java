...
/**
 * <p>Classe Java de DeleteRegionJobInfo complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="DeleteRegionJobInfo"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Result" type="{http://roadnet.com/apex/DataContracts/}DeleteRegionResult" minOccurs="0"/&gt;
...
@XmlType(name = "DeleteRegionJobInfo", propOrder = {
    "overallPercentComplete",
    "result",
    "stage",
    "stagePercentComplete"
})
public class DeleteRegionJobInfo
    extends JobInfo
{
    ...
    protected JAXBElement<DeleteRegionResult> result;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link DeleteRegionResult }{@code >}
     *     
     */
    public JAXBElement<DeleteRegionResult> getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(JAXBElement<DeleteRegionResult> value) {
        this.result = value;
    }

 ...
 *         &lt;element name="travelModelDto" type="{http://roadnet.com/apex/DataContracts/}NetworkTravelModel" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "UpdateTravelModel")
public class UpdateTravelModel {
    ...
    @XmlElementRef(name = "travelModelDto", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<NetworkTravelModel> travelModelDto;
    ...
    /**
     * Obtém o valor da propriedade travelModelDto.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<NetworkTravelModel> getTravelModelDto() {
        return travelModelDto;
    }

    /**
     * Define o valor da propriedade travelModelDto.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link NetworkTravelModel }{@code >}
     *     
     */
    public void setTravelModelDto(JAXBElement<NetworkTravelModel> value) {
        this.travelModelDto = value;
    }

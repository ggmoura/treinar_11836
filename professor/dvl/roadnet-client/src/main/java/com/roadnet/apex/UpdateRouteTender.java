 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}UpdateRouteTenderOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "UpdateRouteTender")
public class UpdateRouteTender {
    ...
    protected JAXBElement<UpdateRouteTenderOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link UpdateRouteTenderOptions }{@code >}
     *     
     */
    public JAXBElement<UpdateRouteTenderOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<UpdateRouteTenderOptions> value) {
        this.options = value;
    }

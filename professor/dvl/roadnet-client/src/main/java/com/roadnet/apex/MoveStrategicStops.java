 ...
 *         &lt;element name="placementDto" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}Placement" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "MoveStrategicStops")
public class MoveStrategicStops {
    ...
    protected JAXBElement<Placement> placementDto;
     ...
     *     
     */
    public JAXBElement<Placement> getPlacementDto() {
        return placementDto;
    }
     ...
     *     
     */
    public void setPlacementDto(JAXBElement<Placement> value) {

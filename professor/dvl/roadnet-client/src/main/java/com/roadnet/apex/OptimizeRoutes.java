 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.Options}OptimizeOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "OptimizeRoutes")
public class OptimizeRoutes {
    ...
    protected JAXBElement<OptimizeOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link OptimizeOptions }{@code >}
     *     
     */
    public JAXBElement<OptimizeOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<OptimizeOptions> value) {
        this.options = value;
    }

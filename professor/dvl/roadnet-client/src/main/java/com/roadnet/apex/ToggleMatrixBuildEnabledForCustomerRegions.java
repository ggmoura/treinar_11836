...
@XmlRootElement(name = "ToggleMatrixBuildEnabledForCustomerRegions")
public class ToggleMatrixBuildEnabledForCustomerRegions {

    protected Long customerEntityKey;
    @XmlElementRef(name = "regionEntityKeys", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)

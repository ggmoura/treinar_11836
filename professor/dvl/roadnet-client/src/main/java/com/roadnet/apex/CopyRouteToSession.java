 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DataContracts}CopyRouteToSessionOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CopyRouteToSession")
public class CopyRouteToSession {
    ...
    protected JAXBElement<CopyRouteToSessionOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CopyRouteToSessionOptions }{@code >}
     *     
     */
    public JAXBElement<CopyRouteToSessionOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<CopyRouteToSessionOptions> value) {
        this.options = value;
    }

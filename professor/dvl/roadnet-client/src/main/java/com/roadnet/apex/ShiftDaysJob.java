 ...
 *         &lt;element name="parameters" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.ShiftDays}ShiftDaysJobParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ShiftDaysJob")
public class ShiftDaysJob {
    ...
    protected JAXBElement<ShiftDaysJobParameters> parameters;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ShiftDaysJobParameters }{@code >}
     *     
     */
    public JAXBElement<ShiftDaysJobParameters> getParameters() {
        return parameters;
    }
     ...
     *     
     */
    public void setParameters(JAXBElement<ShiftDaysJobParameters> value) {

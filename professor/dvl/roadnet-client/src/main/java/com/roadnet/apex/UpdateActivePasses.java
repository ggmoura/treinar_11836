 ...
 *         &lt;element name="options" type="{http://roadnet.com/apex/DataContracts/}UpdateActivePassesParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "UpdateActivePasses")
public class UpdateActivePasses {
    ...
    protected JAXBElement<UpdateActivePassesParameters> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link UpdateActivePassesParameters }{@code >}
     *     
     */
    public JAXBElement<UpdateActivePassesParameters> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<UpdateActivePassesParameters> value) {
        this.options = value;
    }

...
@XmlRootElement(name = "LookupMobileDevice")
public class LookupMobileDevice {

    @XmlElementRef(name = "deviceIdentifier", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)

...
/**
 * <p>Classe Java de StrategicPassTemplatePropertyOptions complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="StrategicPassTemplatePropertyOptions"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "StrategicPassTemplatePropertyOptions", propOrder = {
    "strategicAttributes",
    "strategicAttributesOptions"
})
@XmlSeeAlso({
    AssignDaysPassTemplatePropertyOptions.class,
    CreateTerritoriesPassTemplatePropertyOptions.class
})
public class StrategicPassTemplatePropertyOptions

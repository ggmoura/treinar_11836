 ...
 *         &lt;element name="exceptionInstances" type="{http://roadnet.com/apex/DataContracts/}ArrayOfDomainInstance" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AcknowledgeResourceExceptions")
public class AcknowledgeResourceExceptions {
    ...
    @XmlElementRef(name = "exceptionInstances", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfDomainInstance> exceptionInstances;
    ...
    /**
     * Obtém o valor da propriedade exceptionInstances.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<ArrayOfDomainInstance> getExceptionInstances() {
        return exceptionInstances;
    }

    /**
     * Define o valor da propriedade exceptionInstances.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfDomainInstance }{@code >}
     *     
     */
    public void setExceptionInstances(JAXBElement<ArrayOfDomainInstance> value) {
        this.exceptionInstances = value;
    }

 ...
 *         &lt;element name="criteria" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Mapping.DataContracts}RetrieveTravelPathsAndPolygonsCriteria" minOccurs="0"/&gt;
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Mapping.DataContracts}RetrieveRestrictedPathsAndPolygonsOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveRestrictedPathsAndPolygons")
public class RetrieveRestrictedPathsAndPolygons {
    ...
    protected JAXBElement<RetrieveTravelPathsAndPolygonsCriteria> criteria;
    @XmlElementRef(name = "options", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<RetrieveRestrictedPathsAndPolygonsOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RetrieveTravelPathsAndPolygonsCriteria }{@code >}
     *     
     */
    public JAXBElement<RetrieveTravelPathsAndPolygonsCriteria> getCriteria() {
        return criteria;
    }
     ...
     *     
     */
    public void setCriteria(JAXBElement<RetrieveTravelPathsAndPolygonsCriteria> value) {
        this.criteria = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RetrieveRestrictedPathsAndPolygonsOptions }{@code >}
     *     
     */
    public JAXBElement<RetrieveRestrictedPathsAndPolygonsOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<RetrieveRestrictedPathsAndPolygonsOptions> value) {
        this.options = value;
    }

...
@XmlRootElement(name = "DeleteEquipmentService")
public class DeleteEquipmentService {
    ...
    protected Long equipmentServiceEntityKey;
     ...
     *     
     */
    public Long getEquipmentServiceEntityKey() {
     ...
     *     
     */
    public void setEquipmentServiceEntityKey(Long value) {

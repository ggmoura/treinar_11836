 ...
 *         &lt;element name="criteria" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Mapping.DataContracts}RetrieveEditOperationsCriteria" minOccurs="0"/&gt;
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Mapping.DataContracts}RetrieveEditOperationsOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveEditOperations")
public class RetrieveEditOperations {
    ...
    protected JAXBElement<RetrieveEditOperationsCriteria> criteria;
    @XmlElementRef(name = "options", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<RetrieveEditOperationsOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RetrieveEditOperationsCriteria }{@code >}
     *     
     */
    public JAXBElement<RetrieveEditOperationsCriteria> getCriteria() {
        return criteria;
    }
     ...
     *     
     */
    public void setCriteria(JAXBElement<RetrieveEditOperationsCriteria> value) {
        this.criteria = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RetrieveEditOperationsOptions }{@code >}
     *     
     */
    public JAXBElement<RetrieveEditOperationsOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<RetrieveEditOperationsOptions> value) {
        this.options = value;
    }

 ...
 *         &lt;element name="options" type="{http://roadnet.com/apex/DataContracts/}SearchTypeOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SearchByType")
public class SearchByType {
    ...
    @XmlElementRef(name = "searchString", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    ...
    protected JAXBElement<SearchTypeOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SearchTypeOptions }{@code >}
     *     
     */
    public JAXBElement<SearchTypeOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<SearchTypeOptions> value) {
        this.options = value;
    }

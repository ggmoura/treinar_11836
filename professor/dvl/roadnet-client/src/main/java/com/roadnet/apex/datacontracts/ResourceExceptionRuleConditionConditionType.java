...
/**
 * <p>Classe Java de ResourceExceptionRuleCondition.ConditionType.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * <p>
 * <pre>
 * &lt;simpleType name="ResourceExceptionRuleCondition.ConditionType"&gt;
 ...
 * 
 */
@XmlType(name = "ResourceExceptionRuleCondition.ConditionType")
@XmlEnum
public enum ResourceExceptionRuleConditionConditionType {
    ...
    ResourceExceptionRuleConditionConditionType(String v) {
        value = v;
    }
    ...
    public static ResourceExceptionRuleConditionConditionType fromValue(String v) {
        for (ResourceExceptionRuleConditionConditionType c: ResourceExceptionRuleConditionConditionType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }

 ...
 *         &lt;element name="options" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Query.DataContracts}GetNextOrPreviousRouteOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetPreviousRoute")
public class GetPreviousRoute {
    ...
    protected JAXBElement<GetNextOrPreviousRouteOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetNextOrPreviousRouteOptions }{@code >}
     *     
     */
    public JAXBElement<GetNextOrPreviousRouteOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<GetNextOrPreviousRouteOptions> value) {
        this.options = value;
    }

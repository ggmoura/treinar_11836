 ...
 *         &lt;element name="parameters" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Import}ImportParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Import {
    ...
    protected JAXBElement<ImportParameters> parameters;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ImportParameters }{@code >}
     *     
     */
    public JAXBElement<ImportParameters> getParameters() {
        return parameters;
    }
     ...
     *     
     */
    public void setParameters(JAXBElement<ImportParameters> value) {

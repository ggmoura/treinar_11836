 ...
 *         &lt;element name="parameters" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Query.DataWarehouse}KpiExportParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ExportKpi {
    ...
    protected JAXBElement<KpiExportParameters> parameters;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link KpiExportParameters }{@code >}
     *     
     */
    public JAXBElement<KpiExportParameters> getParameters() {
        return parameters;
    }
     ...
     *     
     */
    public void setParameters(JAXBElement<KpiExportParameters> value) {

 ...
 *         &lt;element name="options" type="{http://roadnet.com/apex/DataContracts/}SearchEquipmentStatusDetailsOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SearchEquipmentStatusDetails")
public class SearchEquipmentStatusDetails {
    ...
    protected JAXBElement<SearchEquipmentStatusDetailsOptions> options;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SearchEquipmentStatusDetailsOptions }{@code >}
     *     
     */
    public JAXBElement<SearchEquipmentStatusDetailsOptions> getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(JAXBElement<SearchEquipmentStatusDetailsOptions> value) {
        this.options = value;
    }

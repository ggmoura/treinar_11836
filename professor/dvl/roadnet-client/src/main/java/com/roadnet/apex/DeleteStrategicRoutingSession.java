 ...
 *         &lt;element name="parameters" type="{http://schemas.datacontract.org/2004/07/Roadnet.Apex.Server.Services.Routing.DeleteStrategicRoutingSession}DeleteStrategicRoutingSessionJobParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "DeleteStrategicRoutingSession")
public class DeleteStrategicRoutingSession {
    ...
    protected JAXBElement<DeleteStrategicRoutingSessionJobParameters> parameters;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link DeleteStrategicRoutingSessionJobParameters }{@code >}
     *     
     */
    public JAXBElement<DeleteStrategicRoutingSessionJobParameters> getParameters() {
        return parameters;
    }
     ...
     *     
     */
    public void setParameters(JAXBElement<DeleteStrategicRoutingSessionJobParameters> value) {

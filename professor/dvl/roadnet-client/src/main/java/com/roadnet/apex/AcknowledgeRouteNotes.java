 ...
 *         &lt;element name="routeNoteInstances" type="{http://roadnet.com/apex/DataContracts/}ArrayOfDomainInstance" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AcknowledgeRouteNotes")
public class AcknowledgeRouteNotes {
    ...
    @XmlElementRef(name = "routeNoteInstances", namespace = "http://roadnet.com/apex/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfDomainInstance> routeNoteInstances;
    ...
    /**
     * Obtém o valor da propriedade routeNoteInstances.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<ArrayOfDomainInstance> getRouteNoteInstances() {
        return routeNoteInstances;
    }

    /**
     * Define o valor da propriedade routeNoteInstances.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfDomainInstance }{@code >}
     *     
     */
    public void setRouteNoteInstances(JAXBElement<ArrayOfDomainInstance> value) {
        this.routeNoteInstances = value;
    }
